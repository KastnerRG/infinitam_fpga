	...
	namespace Objects
	{
		...
		*/
		...
		public:
			...
			inline cl_mem GetVoxelBlocks_cl(void){ return voxelBlocks->GetOpenCLData(); }
			inline cl_mem GetVoxelBlocks_cl(void) const { return voxelBlocks->GetOpenCLData(); }
			inline cl_mem GetAllocationList_cl(void){ return allocationList->GetOpenCLData(); }
			inline cl_mem GetAllocationList_cl(void) const { return allocationList->GetOpenCLData(); }
#endif
