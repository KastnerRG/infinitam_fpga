		...
		*/
		...
		public:
			...
			*/
			...
			cl_mem GetEntries_cl(void) { return hashEntries->GetOpenCLData(); }
			cl_mem GetExcessAllocationList_cl(void) { return excessAllocationList->GetOpenCLData(); }
			cl_mem getIndexData_cl(void) const { return hashEntries->GetOpenCLData(); }
#endif
