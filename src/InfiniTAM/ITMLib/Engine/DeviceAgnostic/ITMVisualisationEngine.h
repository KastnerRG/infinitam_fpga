...
#define EXPERIMENT_KNOB_INTERPOLATE 1
#define EXPERIMENT_KNOB_REFINE      1

#if !EXPERIMENT_KNOB_INTERPOLATE
#define readFromSDF_float_interpolated readFromSDF_float_uninterpolated
#endif
