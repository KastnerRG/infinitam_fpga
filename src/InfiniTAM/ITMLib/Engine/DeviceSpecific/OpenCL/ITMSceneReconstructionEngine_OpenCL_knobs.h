...
#define KNOB2_USE_INDEX_CACHE       1
#define KNOB2_CACHE_HASH_ENTRY      0 // Not sure if that works < 16.0
#define KNOB2_CACHE_VOXEL_DATA      0 // Not sure if that works < 16.0
#define KNOB2_HARDCODE_IMG_SIZE     1 // More a design choice than a knob
#define KNOB2_USE_ND_RANGE          0
#define KNOB2_USE_MINMAXIMG         0 // 0 == no minmaximg, requires a hardcoded max depth;
...
#define KNOB3_HARDCODE_DEPTH_SIZE    0  // more a design choice than a knob, but can influence fmax
#define KNOB3_DEPTH_LOCAL            0  // does not work on CPU/GPU
#define KNOB3_ENTRYID_TYPE           0      // LOOP only
#define KNOB3_XYZ_TYPE               0  // LOOP or WORKITEMS
#define KNOB3_VOXEL_BLOCK_MEM        0
#define KNOB3_UNROLL_ENTRYID         1  // only if KNOB3_ENTRYID_TYPE == LOOP
#define KNOB3_XYZ_FLATTEN_LOOP       0  // very little reason to set it to 0 I think
...
//     - Kernel icp
//
#define KNOB4_INTERPOLATE_POINT      0 // 0: do not interpolate | 1: bilinear interpolation
#define KNOB4_INTERPOLATE_NORMAL     0 // 0: do not interpolate | 1: bilinear interpolation
#define KNOB4_UNROLL_NABLA           1 // 0: no unroll | 1: full unroll
#define KNOB4_UNROLL_HESSIAN         1 // 0: no unroll | 1: full unroll
...
//
	...
	#define WORK_GROUP_SIZE_Y2_NONFPGA 24 // For non-FPGA devices
#else
